...
contract TestToken is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    ...
    constructor( string memory _contractMetadata ) payable ERC721("Test Token", "TEST") EIP712("Test Token", "1") {
