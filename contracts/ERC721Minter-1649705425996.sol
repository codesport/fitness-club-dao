...
contract BetaTeam is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    ...
    constructor( string memory _contractMetadata ) payable ERC721("Beta Team", "BETA") EIP712("Beta Team", "1") {

       salesPrice = 20 * 10**18; // or use: 0.01 ether or  0.01 * 10**18;
       maxSupply = 50;
